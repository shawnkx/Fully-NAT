...
@register_task('translation_lev_rl')
class TranslationLevenshteinRLTask(TranslationTask):
    """
    ...
    def __init__(self, args, src_dict, tgt_dict):
        ...
        self.sg_penalty = args.sg_penalty
    ...
    def setup_task(cls, args, **kwargs):
        ...
        if args.axe_eps:
            blank_sym = '<<BLANK>>'
            src_dict.axe_eps_idx = src_dict.add_symbol(blank_sym)
            tgt_dict.axe_eps_idx = tgt_dict.add_symbol(blank_sym)
    ...
    def train_step(self,
        ...
        loss, sample_size, logging_output = criterion(model, sample, generator)
        if ignore_grad:
            loss *= 0
